define(["jquery","jquery-cookie"],function($){                                                                                                                                                                                                                      
    ...
    function banner(node1,node2,node3,node4,node5,node6,node7,node8,node9){
        ...
        //头部菜单栏：
            ...
            for(var i=0;i< node5.length;i++){
                ...
                $(node5[i]).hover(function(){
                    for(var j=0;j<node5.length;j++){
                        ...
                        $(node4[j]).css("display","none");
                    }
                    $(node5[this.index]).addClass("active");
                    $(node4[this.index]).css("display","flex");
                },function(){
                    $(node4[this.index]).css("display","flex");
                    $(node4[this.index]).hover(
                        function(){
               ...
               //登录注册：
                ...
                for(var i=0;i<banerArr.length;i++){
                    str1+=`
                        <img src="${banerArr[i].image}" id=${banerArr[i].id} alt="">
                    `;
                    str3+=` 
                        <div id="div${banerArr[i].id}">
                            <h1>${banerArr[i].name}</h1>
                            <h3>${banerArr[i].character}<h3>
                            <a href="">立即购买</a>
                        </div>`;
                    str2+=`
                        <li id=${banerArr[i].id}></li>
                        `;
                }
                    str1+=`
                        <img src="${banerArr[0].image}" id=${banerArr[0].id} alt="">
                        `;
                    str3+=`
                        <div id="div${banerArr[0].id}">
            ...
            $(node9[0]).css("display","inline-block");  
            for(var i=0;i< node8.length;i++){
                ...
                $(node8[i]).hover(function(){
                    ...
                    $(node9[this.index]).css("display","inline-block");
                },function(){
